...
public class Exercise11_14 {
    ...
    static int displayMenu() {
        ...
        while (true) {
            try {
                ...
                System.out.println("입력이 유효하지 않습니다. 다시 입력해주세요");
            }
        }
    ...
    static void inputRecord() {
        ...
        System.out.println("q 를 입력하면 메인화면으로 돌아갑니다.");
        System.out.println();
        ...
        while (true) {
            ...
            if (input.equalsIgnoreCase("q")) {
                System.out.println("q 를 입력하셨습니다. 시스템을 종료합니다");
                break;
            }
            try {
                Scanner s2 = new Scanner(input).useDelimiter(",");
                Student stu = new Student(s2.next(), s2.nextInt(), s2.nextInt(), s2.nextInt(), s2.nextInt(), s2.nextInt());
                record.add(stu);
            } catch (Exception e) {
